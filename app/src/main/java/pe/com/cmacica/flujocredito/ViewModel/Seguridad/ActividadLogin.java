...
public class ActividadLogin extends AppCompatActivity   {
    ...
    public void OnUnlockAccount(){
        ...
        if (txtUser.getText().toString().equals("")) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setTitle("Aviso")
                    .setMessage("No se encuentra usuario debido a que el dispositivo no está registrado.")
        ...
        try{
            if(response.getBoolean("IsCorrect")){
                new AlertDialog.Builder(this)
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setTitle("Aviso")
                        .setMessage("Se desbloqueó la cuenta correctamente.")
                        .setPositiveButton(android.R.string.ok, (dialog, which) -> dialog.dismiss())
                        .show();
            } else {
    ...
    public void OnResetPassword(){
        ...
        new AlertDialog.Builder(this)
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setTitle("Aviso")
                .setMessage("¿Está seguro de resetear su contraseña?")
                .setPositiveButton(android.R.string.yes, (dialog, which) -> {
                    dialog.dismiss();
                    progressDialog = ProgressDialog.show(this,"Espere por favor","Restableciendo contraseña.");
                    HashMap<String, String> cabeceras = new HashMap<>();
                    gsonpojo = new GsonBuilder().create();
        ...
        try{
            if(response.getBoolean("IsCorrect")){
                ...
                new AlertDialog.Builder(this)
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setTitle("Aviso")
                        .setMessage("Tu nueva contraseña temporal es: " + password + "\n\nPor favor, inicia sesión en un equipo con esta contraseña para poder actualizarla.")
                        .setPositiveButton(android.R.string.ok, (dialog, which) -> dialog.dismiss())
                        .show();
            } else {
                Toast.makeText(this, response.getString("Message"), Toast.LENGTH_LONG).show();
