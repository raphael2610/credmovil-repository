...
public class ContratoDbCmacIca {
    ...
    private static final String RUTA_Constantes = "Constantes";
    ...
    public static class ConstanteTable implements BaseColumns,ColumnasConstantes{

        public static final Uri URI_CONTENIDO = URI_BASE.buildUpon().appendPath(RUTA_Constantes).build();

        public static Uri crearUriConstantes(String id) {
            return URI_CONTENIDO.buildUpon().appendPath(id).build();
        }

        public static String obtenerIdConstantes(Uri uri) {
            return uri.getLastPathSegment();
        }
