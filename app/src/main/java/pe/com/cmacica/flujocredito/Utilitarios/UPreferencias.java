...
public class UPreferencias {
    ...
    private static final String PreferenciaCodAgencia="cmacica.CodAgencia";
    private static final String PreferenciaCargoPersona="cmacica.rhCargo";
    ...
    public static void GuardarDatosUsuarios(Context contexto, String Usuario,String Nombre , String CodigoPersona, String NombreAgencia,String CodAgencia, String CargoPersona ){
        ...
        sp.edit().putString(PreferenciaCodAgencia,CodAgencia).apply();
        sp.edit().putString(PreferenciaCargoPersona, CargoPersona).apply();
    }
    ...
    public static String ObtenerCodAgencia(Context contexto){

        return getDefaultSharedPreferences(contexto).getString(PreferenciaCodAgencia,null);
    }
    public static String ObtenerCargoPersona(Context contexto){

        return getDefaultSharedPreferences(contexto).getString(PreferenciaCargoPersona,null);
    }
    //endregion
    ...
    public static String ObtenerImei(Context contexto){
        ...
        return getDefaultSharedPreferences(contexto).getString(PreferenciaImei,"");
    }
    //endregion
