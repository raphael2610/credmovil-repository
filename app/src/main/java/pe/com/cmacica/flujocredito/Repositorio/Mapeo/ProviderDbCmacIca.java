...
//public class ProviderDbCmacIca {
    ...
    public static final int URIConstantes = 700;
    public static final int URIConstantes_Id = 701;
    static {
        ...
        uriMatcher.addURI(ContratoDbCmacIca.AUTORIDAD, "Constantes",URIConstantes);
        uriMatcher.addURI(ContratoDbCmacIca.AUTORIDAD, "Constantes/*" , URIConstantes_Id);
   }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (match){
            ...
            case URIConstantes:
                ...
                c=  bd.query(DbCmacIcaHelper.Tablas.Constantes,projection,selection,selectionArgs,null,null,sortOrder);
                break;
            case URIConstantes_Id:
                id = ContratoDbCmacIca.ConstanteTable.obtenerIdConstantes(uri);

                c= bd.query(DbCmacIcaHelper.Tablas.Constantes,projection,ContratoDbCmacIca.ConstanteTable.nConsCod+ " = ?", new String[]{id},null,null,null);
                break;
            default:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case URIConstantes:
                bd.insertOrThrow(DbCmacIcaHelper.Tablas.Constantes ,null,values);
                notificarCambio(uri);
                return ContratoDbCmacIca.ConstanteTable.crearUriConstantes(id);
            default:
                throw new UnsupportedOperationException(URI_NO_SOPORTADA);
        }
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case URIConstantes:
                afectados = bd.delete(
                        DbCmacIcaHelper.Tablas.Constantes,null,
                        null);
                notificarCambio(uri);
                break;
            default:
