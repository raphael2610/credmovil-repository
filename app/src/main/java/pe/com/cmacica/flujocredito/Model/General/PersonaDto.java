...
public class PersonaDto {
   ...
   public PersonaDto(String idPersona, String cPersCod, String cPersNombre, String cDoi, String cDireccion,
                      String dVersion, String nEstadoOpe) {
    ...
    private String cPersCod;  //CodigoPersona
    private String cPersNombre ; //NombrePersona
    private String cDoi ;  //NumeroDocumento
    private String cDireccion;  //Direccion
